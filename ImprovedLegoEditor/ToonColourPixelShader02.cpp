...
*  ToonColourPixelShader02.cpp
*  Contains the function definitions for the ToonColourPixelShader02 class.
*/

#include "ToonColourPixelShader02.h"


ToonColourPixelShader02::ToonColourPixelShader02( void ) : PixelShader(), 
...
//--------------------------------------------------------------------------------------
HRESULT ToonColourPixelShader02::Initialise( ID3D11Device* pDevice )
{
	HRESULT hr;

	// Create the shader

	hr = pDevice -> CreatePixelShader( g_toonColourPixelShader02, sizeof( g_toonColourPixelShader02 ), nullptr, &m_pPixelShader );
	if( FAILED ( hr ) )
	{
		return hr;
	}
...
//--------------------------------------------------------------------------------------
HRESULT ToonColourPixelShader02::Cleanup( void )
{
...
//--------------------------------------------------------------------------------------
HRESULT ToonColourPixelShader02::UpdatePerSceneData( ID3D11DeviceContext* pContext, const PerSceneData& perSceneData)
{
...
//--------------------------------------------------------------------------------------
HRESULT ToonColourPixelShader02::UpdatePerFrameData( ID3D11DeviceContext* pContext, const PerFrameData& perFrameData)
{
...
//--------------------------------------------------------------------------------------
HRESULT ToonColourPixelShader02::UpdatePerObjectData( ID3D11DeviceContext* pContext, const PerObjectData& perObjectData)
{
...
//--------------------------------------------------------------------------------------
HRESULT ToonColourPixelShader02::UpdateTextureResource( int index, ID3D11DeviceContext* pContext, ID3D11ShaderResourceView* pTexture, ID3D11SamplerState* pSamplerState )
{
	if( index != 0 )
	{
		return E_FAIL;
