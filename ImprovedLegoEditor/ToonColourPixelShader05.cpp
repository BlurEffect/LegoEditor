...
*  ToonColourPixelShader05.cpp
*  Contains the function definitions for the ToonColourPixelShader05 class.
*/

#include "ToonColourPixelShader05.h"


ToonColourPixelShader05::ToonColourPixelShader05( void ) : PixelShader(), 
...
//--------------------------------------------------------------------------------------
HRESULT ToonColourPixelShader05::Initialise( ID3D11Device* pDevice )
{
	HRESULT hr;

	// Create the shader

	hr = pDevice -> CreatePixelShader( g_toonColourPixelShader05, sizeof( g_toonColourPixelShader05 ), nullptr, &m_pPixelShader );
	if( FAILED ( hr ) )
	{
		return hr;
	}
...
//--------------------------------------------------------------------------------------
HRESULT ToonColourPixelShader05::Cleanup( void )
{
...
//--------------------------------------------------------------------------------------
HRESULT ToonColourPixelShader05::UpdatePerSceneData( ID3D11DeviceContext* pContext, const PerSceneData& perSceneData)
{
...
//--------------------------------------------------------------------------------------
HRESULT ToonColourPixelShader05::UpdatePerFrameData( ID3D11DeviceContext* pContext, const PerFrameData& perFrameData)
{
...
//--------------------------------------------------------------------------------------
HRESULT ToonColourPixelShader05::UpdatePerObjectData( ID3D11DeviceContext* pContext, const PerObjectData& perObjectData)
{
...
//--------------------------------------------------------------------------------------
HRESULT ToonColourPixelShader05::UpdateTextureResource( int index, ID3D11DeviceContext* pContext, ID3D11ShaderResourceView* pTexture, ID3D11SamplerState* pSamplerState )
{
	if( index != 0 )
	{
		return E_FAIL;
